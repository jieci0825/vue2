  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="addressList in addressInfo"
        :key="addressList.id"
      >
        <span
          class="username"
        ...
        >
        <p @click="changeDefault(addressList, addressInfo)">
          <span class="s1">{{ addressList.fullAddress }}</span>
          <span class="s2">{{ addressList.phoneNum }}</span>
          <span class="s3" v-show="addressList.isDefault == 1">默认地址</span>
        </p>
      </div>
      <div class="line"></div>
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch('getOrederInfo')
  },
  ...
  methods: {
    // 点击修改默认地址
    changeDefault(addressList, addressInfo) {
